...
export const ResetSubTitle = styled.h2`
  font-weight: 700;
  font-size: 18px;
  margin-top: 35px;
...
export const FormResetBody = styled.form`
  display: flex;
  flex-direction: column;
  gap: 40px;
  margin-top: 25px;
...
export const GroupInputReset = styled.div`
  display: flex;
  flex-direction: column;
  gap: 5px;
`;

export const LabelInputReset = styled.label`
  font-weight: 500;
  font-size: 18px;
`;

export const TextInputReset = styled.input`
  padding: 12px 15px;
  font-size: 16px;
...
export const ButtonSubmitReset = styled.button`
  width: 75%;
  align-self: center;
  font-family: 'Rubik';
  font-size: 20px;
